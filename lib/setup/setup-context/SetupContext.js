...
export default class {
  ...
  addCustomPageEventListener(scope, eventname, handler, once = false) {
    this.assertIsActive("add custom page event listeners");
    return false;
  }
  ...
  subscribePageProvidedDataReady(scope, handler) {
    this.assertIsActive("add page data provide listen");
    this.assertIsOfType("Component", "add page data provide listen");
    return true;
  }
