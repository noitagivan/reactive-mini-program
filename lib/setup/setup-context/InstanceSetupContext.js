...
import { ObjectiveSignal } from "../../state/objective/wrappers";
...
class SetupProps extends ObjectiveSignal {}
...
export default class extends SetupContext {
  ...
  defineProperties(definations) {
    ...
    const [signal, assign] = useObjectiveSignal(values, SetupProps);
    console.log("defineProperties", signal);
