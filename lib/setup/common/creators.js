...
import InstanceSetupScope from "../InstanceSetupScope";
 ...
 * @param { InstanceSetupScope } scope
 * @returns { DefinationContext }
 */
export default function createDefinationContext(setupCtx, scope) {
