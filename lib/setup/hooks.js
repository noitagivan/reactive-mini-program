...
export function onBeforeMounted(handler) {
  useCurrentSettingUpInstanceScope()?.on("beforemounted", handler);
}
...
export function onMounted(handler) {
  useCurrentSettingUpInstanceScope()?.on("mounted", handler);
}
...
export function onUnmounted(handler) {
  useCurrentSettingUpInstanceScope()?.on("dispose", handler);
}
