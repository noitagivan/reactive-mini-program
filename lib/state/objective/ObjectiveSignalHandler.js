...
export class ObjectiveSignalHandler {
  __func_signal = null;
  __visitors = null;
  __emit = null;
...
export class MutableObjectiveSignalHandler extends ObjectiveSignalHandler {
  set(t, p, v, r) {
    return this.__visitors?.Assignment?.([p, v]) ? this.__emit() : false;
  }
}

export class NestedObjectiveSignalHandler extends ObjectiveSignalHandler {
  set(t, p, v, r) {
